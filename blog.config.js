...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Iris Zou', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通人,干什么都三分钟热度，这辈子唯一坚持到现在的事情是活着和学习，希望能继续坚持下去', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Iris-Zou.com', // 网站地址
